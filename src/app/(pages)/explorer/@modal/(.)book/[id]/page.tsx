...
import { Modal, Stats } from '@/components'
...
export default async function InterceptedBookPage({ params }: { params: Promise<{ id: string }> }) {
          ...
          <div className="flex flex-col justify-between">
            ...
            <div>
              ...
              <span className="text-body-sm text-gray-400">
                {book.total_rating} {book.total_rating > 1 ? 'avaliações' : 'avaliação'}
              </span>
            </div>
          </div>
        </div>
